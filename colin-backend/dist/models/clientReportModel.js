...
const ClientReportSchema = new mongoose_1.Schema({
    ...
    generatedByUserId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User' },
}, { timestamps: true });
exports.default = mongoose_1.default.model('ClientReport', ClientReportSchema);
//# sourceMappingURL=clientReportModel.js.map